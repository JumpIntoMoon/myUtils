...
<head>
    ...
    <script src="<%request.getContextPath();%>/static/js/jquery/jquery-3.3.1.min.js"></script>
            ...
            if (urlPath.indexOf('sockjs') != -1) {
                ...
                if (window.location.protocol == 'http:') {
                    if (window.location.host != '') {
                        ...
                        url = 'ws://' + 'localhost:8080' + urlPath;
                    }
                } else {
                    if (window.location.host != '') {
                        url = 'wss://' + window.location.host + urlPath;
                    } else {
                        url = 'wss://' + 'localhost:8080' + urlPath;
                    }
                }
